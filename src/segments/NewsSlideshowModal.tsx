    ...
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" className="fixed z-50 inset-0 overflow-y-auto" onClose={onClose}>
        <div className="flex items-center justify-center min-h-screen px-2 py-4 text-center sm:block sm:p-0">
          ...
          >
            <div className="inline-block align-bottom bg-white dark:bg-gray-900 rounded-2xl px-4 pt-6 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl w-full max-w-[95vw]">
              {/* Header */}
              <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-extrabold tracking-wide text-gray-900 dark:text-white font-sans drop-shadow-sm" style={{letterSpacing: '0.04em'}}>{stockSymbol} News & Market Intelligence</h2>
                  ...
                  <div className="relative">
                    ...
                    <div className="relative bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-xl p-6 min-h-[500px]">
                      ...
                      <div className="text-center max-w-4xl mx-auto">
                        ...
                        {/* News Description */}
                        <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed text-lg line-clamp-4">
